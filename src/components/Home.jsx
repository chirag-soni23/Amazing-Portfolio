  ...
  return (
    <div className="flex flex-col md:flex-row w-full items-center justify-between h-full p-6 px-40 mt-40 font-bold">
      <div className="text-white text-center md:text-left md:w-1/2 space-y-4">
        ...
        <h1 className="text-3xl md:text-4xl font-bold uppercase">I AM A  <ReactTyped strings={["chirag soni","software engineer"]}  typeSpeed={50} loop backSpeed={30} /></h1>
       
        <p className="text-sm md:text-base max-w-lg mx-auto md:mx-0">
